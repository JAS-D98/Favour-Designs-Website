...
const DesignsBanner = ({ searchTerm, setSearchTerm, handleFilterChange }) => {
  ...
  return (
    <div className='bg-gradient-to-t from-black to-red-600 h-52 sm:h-56 bg-cover bg-center flex justify-end flex-col items-center text-2xl sm:text-6xl text-white font-semibold w-full fixed top-0 pb-2'>
      ...
      <div className='flex justify-between flex-col-reverse sm:flex-row-reverse gap-2 sm:gap-6 text-[16px] text-slate-600'>
        ...
        <div className='flex gap-2 items-center justify-center flex-wrap sm:gap-12'>
