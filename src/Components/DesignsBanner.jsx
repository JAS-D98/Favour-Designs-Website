...
const DesignsBanner = ({ searchTerm, setSearchTerm, handleFilterChange }) => {
  ...
  return (
    <div className='bg-gradient-to-t from-black to-red-600 h-52 sm:h-56 bg-cover bg-center flex justify-end flex-col items-center text-xl sm:text-6xl text-white font-semibold w-full fixed top-0 pb-2'>
