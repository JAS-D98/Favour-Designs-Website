...
const QualitySection = () => {
  return (
    <section className="flex h-100 justify-between p-8 sm:p-2 flex-col md:flex-row sm:mt-20 sm:ml-12 sm:mr-12 gap-9 flex-reverse">
      <div className=" p-2 min-w-[200px] w-full sm:p-8 sm:min-w-[400px] text-left sm:w-full bg-slate-200 h-auto rounded-3xl m-auto">
