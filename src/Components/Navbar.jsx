  ...
  return (
    <header className="px-6 py-2 sm:px-8 sm:py-4 z-10 w-full border-b-2 shadow-sm bg-white fixed">
        <nav className="flex justify-between items-center max-container">
            <a href="/" className="text-[16px] font-bold italic sm:text-xl sm:ml-6 sm:flex sm:flex-row sm:items-center justify-center md:text-2xl"><span className="text-firebrick"><h1 className="text-2xl sm:text-4xl -mb-6 mr-3">F</h1> D</span> Favoured Designs</a>
